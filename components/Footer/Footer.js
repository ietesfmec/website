        ...
        <div ref={el} className={styles.encloser} style={secondary ? { backgroundColor: c2, color: c1 } : { backgroundColor: c1, color: c2 }}>
            <main>
                <section className={styles.social}>
                    ...
                    <svg onClick={handleLink('https://medium.com/iete-sf-mec')} width="24" height="15" viewBox="0 0 24 15" fill="none" xmlns="http://www.w3.org/2000/svg">
