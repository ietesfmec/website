...
export default function Info() {
    const [text, setText] = useState(
        <>
            <p>The Institution of Electronics and Telecommunication Engineers (IETE) is India's leading recognised professional society devoted to the advancement of Science and Technology of Electronics, Telecommunication & IT. Founded in 1953.</p>
                    <br/>
            <p>IETE is the National Apex Professional body of Electronics and Telecommunication, Computer Science and IT Professionals. It serves more than 1,25,000 members (including Corporate, Student and ISF members) through 63 Centres, spread all over India and abroad.</p>
                    <br/>
            <p>IETE focuses on advancement of the Science and Technology of Electronics, Telecommunication, Computers, Information Technology and related areas. Towards this end the Institution promotes and conducts basic engineering and continuing technical education programmes for human resource development.</p>
        </>
    )
    return(
        <div className={styles.encloser}>
            ...
            <main className={styles.main}>
                <div>
                   ...
                   {text}
                    ...
                    <>
                        ...
                        etc. Skilling programmes have been conducted in
                ...
                <div>
                    <h1>Aim</h1>
                    <p>One of the important charter of IETE is to impart continuing engineering education to
                    ...
                    cannot afford engineering education at a regular engineering college.</p>
                    <span></span>
                </div>
                <div>
                    <h1>Working</h1>
                    <p>IETE conducts technical activities like, conferences, workshops, exhibitions, 
                        ...
                        professional development of its members.</p>
                    <span></span>
                </div>
            </main>
      </div>
